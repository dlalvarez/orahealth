...
class HTMLReporter:
    ...
    def _fallback_render(
        ...
        **_: Any,
        ...
        style = """
        <style>body{margin:0;background:#f4f7fb;color:#172033;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;line-height:1.5}.page{max-width:1180px;margin:auto;padding:28px}.hero,section{background:#fff;border:1px solid #dfe7f1;border-radius:20px;box-shadow:0 10px 30px rgba(23,32,51,.08);padding:24px;margin:18px 0}.hero{background:linear-gradient(135deg,#13213a,#234876);color:#fff}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(170px,1fr));gap:12px}.card{background:#fff;border:1px solid #dfe7f1;border-radius:16px;padding:14px;color:#172033}.card span{color:#637083;font-size:.8rem}.card strong{display:block;font-size:1.4rem;word-break:break-word}.badge{display:inline-flex;gap:6px;border-radius:999px;padding:6px 11px;font-weight:700;font-size:.78rem}.PASS{color:#15803d;background:#dcfce7}.INFO{color:#1d4ed8;background:#dbeafe}.WARNING{color:#b45309;background:#fef3c7}.FAIL{color:#dc2626;background:#fee2e2}.CRITICAL{color:#7f1d1d;background:#fecaca}.ERROR{color:#581c87;background:#f3e8ff}.SKIPPED{color:#64748b;background:#f1f5f9}.table-wrap{overflow-x:auto}table{width:100%;border-collapse:collapse}th,td{padding:10px;border-bottom:1px solid #dfe7f1;text-align:left;vertical-align:top}th{background:#f8fafc;color:#475569;text-transform:uppercase;font-size:.76rem}pre{background:#0f172a;color:#e2e8f0;border-radius:12px;padding:12px;max-height:240px;overflow:auto;white-space:pre-wrap}.positive{border-left:6px solid #15803d;background:#f0fdf4;padding:14px;border-radius:12px}</style>
        """
